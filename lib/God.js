...
function handleExit(clu, exit_code) {
  ...
  var stopping    = (clu.pm2_env.status == cst.STOPPING_STATUS || clu.pm2_env.status == cst.ERRORED_STATUS
    ||  clu.pm2_env.status == cst.STOPPED_STATUS) ? true : false;
  var overlimit   = false;var overlimit   = false;
